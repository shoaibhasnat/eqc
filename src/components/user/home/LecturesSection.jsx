...
import LecturesDataJson from '../lectures/LecturesData.json';
...
const LecturesSection = () => {
  ...
  const services = lecturesData.lectures
    ?.slice(0, 4)
    .map((lecture) => {
      ...
      <Container maxWidth="xlg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Stack direction="row" justifyContent="center" alignItems="center" sx={{ mt: 4 }}>
          <Button
            ...
            boxShadow: "0 8px 25px rgba(184, 112, 47, 0.4)",
            "&:hover": {
              backgroundColor: "var(--color-primary-hover)",
              transform: "translateY(-2px)",
              boxShadow: "0 12px 30px rgba(184, 112, 47, 0.5)",
            },
           }}>
            {lecturesData.ctaBtnText}
          </Button>
        </Stack>
      </Container>
